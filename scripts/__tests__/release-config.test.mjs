...
describe('release-candidate configuration', () => {
	it('prepares the provenance release as 0.1.1', () => {
	...
	it('publishes tagged releases from GitHub Actions with npm provenance', () => {
		...
		expect(publish).not.toMatch(/NODE_AUTH_TOKEN|NPM_TOKEN|environment:/);
	});
