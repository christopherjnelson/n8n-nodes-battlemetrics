...
happens, only the verified Server and Game resources are presented in the UI. Server Get/Get Many and
Game Get Many carry the documented live-confirmation limitations; all query filters, all other
resources, and all other Game operations remain deferred.
