...
Preserve the proven npm Trusted Publisher configuration used for `0.1.1`:
...
6. Run the published beta community-package scanner and resubmit the Creator Portal only when it is
   clean.
